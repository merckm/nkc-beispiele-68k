...
* DRUCKROUTINE FUER EPSONDRUCKER
* COPYRIGHT (C) 1985 BY :
* RUEDIGER BAECKER - POSTFACH 4111 - 5820 GEVELSBERG 11
* AUS LOOP Nr 04 Seite 11
...
Q:                          * ENTRY 
 MOVE #ESC,D0               * DRUCKER AUF NORMALMODUS
 BSR LO
 MOVE #'R',D0
 BSR LO
 MOVE #0,D0
...
INITA1:                     * ZEILENABSTAND VORBELEGEN
 MOVE #ESC,D0
 BSR LO
...
INITLR:                     * LINKEN RAND SETZEN
 ...
 MOVE #!LST,D7              * UMSCHALTEN AUF DRUCKERAUSGABE
 TRAP #1
